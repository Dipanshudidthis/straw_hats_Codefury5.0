        ...
        <>
            <Container className={classes.container} style={{ background: "#D5D6EA" }}>
                ...
                <motion.div className={classes.item}
                    variants={buttonVariants} whileHover="hover"
                >
                    <Link to="/interest" style={{ color: "black" }}><BeenhereIcon className={classes.icon} /></Link>
                    <Link to="/interest" style={{ textDecoration: "none" }}><Typography className={classes.text}>Interest</Typography></Link>
                </motion.div>
