...
userSchema.statics.signup = async function(orgname, email, phoneNumber, about, password) {

    //validation
    if(!email || !password || !phoneNumber || !about || !orgname){
    ...
    const user = await this.create({ orgname, email, phoneNumber, about, password : hash });
